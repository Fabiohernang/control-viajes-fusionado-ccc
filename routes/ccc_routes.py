...
from models import CCCPeriodo, CCCCuenta, CCCMovimiento, CCCAccion
from routes.auth_routes import login_required
from services.ccc_service import (
    ccc_decimal, ccc_serialize_cuenta, ccc_parse_date, ccc_month_summary,
    ccc_build_blocks_for_cuenta, ccc_get_message_template, ccc_format_message, ccc_set_message_template
)
from utils import quantize_money


def register_ccc_routes(app):
    @app.route("/ccc")
    @login_required
    def ccc_index():
